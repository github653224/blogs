...
> 由于工作时间较长，简历内容较多，编写此微简历，方便面试官快速了解我的基本情况，如有需要可点击<a href="https://docs.qq.com/pdf/DVXRaa2JFbWZYYXhK">下载完整版简历</a>，谢谢！
...
1. 熟悉企业软件敏捷迭代开发流程，测试流程及规范，能深层次理解需求，在项目各个阶段熟练进行软件功能的黑盒、自动化及性能测试工作及时发现问题及风险并推进解决。
2. 熟悉测试计划编写、测试用例设计及评审、Bug流程及管理，测试报告的编写。
3. 了解Devops持续测试及测试左移右移思想，在软件开发各个阶段尽早接入测试，尽早发现问题，发挥测试最大价值。
3. 熟悉开源自动化测试框架：Python+RF/Requests/Appium/Selenium/+Pytest+Allure+Jenkins编写服务端/移动端/UI自动化测试脚本结合CI/CD工具持续测试，有设计封装PageObject自动化测试框架并落地实践经验。


> SQL&Linux：  

1. 熟悉MySQL、SQL Server、Oracle等主流数据库，熟悉标准SQL语句，如CRUD，逻辑业务查询验证，数据导入导出备份，索引，SQL性能优化分析等。
2. 熟悉Linux系统常用命令及shell脚本语言，了解Nginx, Tomcat web服务容器， Redis等服务中间件的使用，能使用shell编写测试脚本辅助业务测试提效等。
...
<tr >
    <td colspan="3">
      3. 根据产品设计或需求，进行需求分析，制定测试计划、风险评估、设计测试用例，执行测试用例，准确定位并追踪问题等。
    </td>
</tr>

<tr >
    <td colspan="3">
      4. 对线上问题进行持续追踪，并从中得出一些优化监控、提升测试方案的改进措施。
    </td>
</tr>

<tr >
    <td colspan="3">
      5. 对产品提出改进建议以建立更佳的用户感受，对项目提出改进建议以提高项目整体效率。
    </td>
</tr>
...
<tr >
  ...
  <tr >
    <td colspan="3">
      1. 入职以来从未出现因为延期漏测等原因出现线上事故导致的客诉，多次季度绩效评选为A。
    </td>
  </tr>
<tr >
    <td colspan="3">
...
<tr >
  ...
  <tr >
    <td colspan="3">
      1. 历时一年零5个月，从0到1，从无到有，带领测试小团队冲刺上线公司战略级项目多个里程碑功能，如期上线直至维稳，得到领导一致好评和奖赏。
    </td>
  </tr>
